    ...
    <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
      <div className="flex flex-col flex-grow bg-white border-r border-gray-100 overflow-y-auto">
        ...
        <div className="flex items-center gap-2.5 px-6 py-5 border-b border-gray-100">
          ...
          <span className="text-lg font-bold text-gray-900">SendIt</span>
        </div>
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          ...
          <form action={logoutAction}>
            <button
              type="submit"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition"
            >
