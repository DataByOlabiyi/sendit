      ...
      <div className="mt-6">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition disabled:opacity-60"
          >
