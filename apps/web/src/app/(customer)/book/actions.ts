...
export async function createOrderAction(data: unknown) {
  ...
  if (validData.payment_method === 'wallet') {
    ...
    const { data: orderId, error: walletOrderError } = await admin.rpc('create_wallet_order', {
      ...
      p_delivery_contact_name:  validData.delivery_contact_name,
      p_delivery_contact_phone: validData.delivery_contact_phone,
  ...
  const { data: order, error } = await supabase
    ...
    .insert({
      ...
      delivery_contact_name:   validData.delivery_contact_name,
      delivery_contact_phone:  validData.delivery_contact_phone,
